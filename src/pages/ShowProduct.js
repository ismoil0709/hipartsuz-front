...
export default function () {
    ...
    return (
        <div className="mantine-Paper-root mantine-Modal-modal mantine-adyf3h"
            style={{
            ...
            <div id="mantine-r1-body" className="mantine-l553vn mantine-Modal-body">
                ...
                <h4 className="mantine-Text-root mantine-Title-root mantine-1dv2r7k">{product.name}</h4>
                <div className="mantine-Text-root mantine-1pbxw0k">{product.description === undefined ? product.name : product.description}</div>
                <div className="mantine-1r5gzak">
                    <h5 className="mantine-Text-root mantine-Title-root mantine-1s1l1dq">Quantity:</h5>
                    <div className="mantine-1523trd"><button
                        className="mantine-UnstyledButton-root mantine-Button-root mantine-13fglg0"
                        type="button" data-button="true">
                        <div onClick={() => modifyCount(product_count - 1)} className="mantine-3xbgk5 mantine-Button-inner"><span
                        ...
                        <div className="mantine-Text-root mantine-1pbxw0k">{product_count}</div><button
                            className="mantine-UnstyledButton-root mantine-Button-root mantine-13fglg0"
                            type="button" data-button="true">
                            <div onClick={() => modifyCount(product_count + 1)} className="mantine-3xbgk5 mantine-Button-inner"><span
                                className="mantine-qo1k2 mantine-Button-label"><svg
                ...
                <div className="mantine-16132zt">
                    <div className="mantine-Container-root mantine-1y0ftcf">
                        ...
                        <div class="mantine-1o499t4">
                            ...
                            <div class="mantine-Text-root mantine-ywpxau">{product.price} so'm</div>
                        </div>
                            )}
                        <button
